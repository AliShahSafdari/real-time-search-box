...
**Real time search :** is created by Ruby Language and Rails framework and we can search articles in real time. 
...
### Usage
1. Install Ruby and Rials
2. Clone this repo 
```
git clone git@github.com:AliShahSafdari/blog_app.git
```
3. open VScode terminal and run
```
rails s
```
